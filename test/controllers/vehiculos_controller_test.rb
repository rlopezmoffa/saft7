...
class VehiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehiculo" do
    assert_difference("Vehiculo.count") do
      post vehiculos_url, params: { vehiculo: { codigo: @vehiculo.codigo, marca: @vehiculo.marca, matricula: @vehiculo.matricula, modelo: @vehiculo.modelo } }
    end
  ...
  test "should update vehiculo" do
    patch vehiculo_url(@vehiculo), params: { vehiculo: { codigo: @vehiculo.codigo, marca: @vehiculo.marca, matricula: @vehiculo.matricula, modelo: @vehiculo.modelo } }
