...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference("Empresa.count") do
      post empresas_url, params: { empresa: { direccion: @empresa.direccion, nombre: @empresa.nombre, nro_bps: @empresa.nro_bps, rut: @empresa.rut } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { direccion: @empresa.direccion, nombre: @empresa.nombre, nro_bps: @empresa.nro_bps, rut: @empresa.rut } }
