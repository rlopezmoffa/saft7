class VehiculosController < ApplicationController
  ...
  def create
    ...
    @vehiculo.administracion_id = Session.new(nil).get_administracion_id

    respond_to do |format|
      if @vehiculo.save
        format.html { redirect_to vehiculos_path }
  ...
  private
    ...
    def vehiculo_params
      params.require(:vehiculo).permit(:codigo, :marca, :modelo, :matricula, :empresa_id,
      :seguro, :padron, :motor, :chasis, :combustible, :observaciones, :movil)
    end
end
